...
public class UserController extends ControllerSupport {
    ...
    public String dashboard(Authentication authentication, Model model) {
        ...
        model.addAttribute("malpracticeBlockedTopics", QUIZ_TOPICS.stream()
                .filter(topic -> resultRepository.existsByUserAndCategoryIgnoreCaseAndMalpracticeDetectedTrue(user, topic))
                .toList());
